 ...
 */ !function(e, t) {
    ...
    function S() {
        for(var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = [
            "__proto__",
            "constructor",
            "prototype"
    ...
    var W = {
        ...
        update: {
            ...
            updateClickedSlide: function(e) {
                ...
                if (s) {
                    for(var n = 0; n < a.slides.length; n += 1)if (a.slides[n] === s) {
                        r = !0, t = n;
                        break;
                    }
                }
        ...
        classes: {
            addClasses: function() {
                var e, t, a, i = this, s = i.classNames, r = i.params, n = i.rtl, l = i.$el, o = i.device, d = i.support, p = (e = [
                    "initialized",
                    r.direction,
                    {
    ...
    var Z = {
        ...
        pause: function(e) {
            var t = this;
            t.autoplay.running && (t.autoplay.paused || (t.autoplay.timeout && clearTimeout(t.autoplay.timeout), t.autoplay.paused = !0, 0 !== e && t.params.autoplay.waitForTransition ? [
                "transitionend",
                "webkitTransitionEnd"
            ].forEach(function(e) {
...
//# sourceMappingURL=index.a9b20216.js.map
